...
<<<<<<< HEAD:scripts/eastern_kingdoms/naxxramas/boss_kelthuzad.cpp
        m_pInstance = (ScriptedInstance*)pCreature->GetInstanceData();
=======
        m_pInstance = (instance_naxxramas*)pCreature->GetInstanceData();
        m_bIsRegularMode = pCreature->GetMap()->IsRegularDifficulty();
>>>>>>> af747c3... Redesign instance script for Naxx:scripts/northrend/naxxramas/boss_kelthuzad.cpp
        Reset();
    }
...
>>>>>>> 77b09ea... Add areatrigger script for end boss, naxx.:scripts/northrend/naxxramas/boss_kelthuzad.cpp
