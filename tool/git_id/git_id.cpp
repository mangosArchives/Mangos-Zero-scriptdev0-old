 ...
 * Copyright (C) 2009-2010 ScriptDevZero <http://github.com/scriptdev/scriptdevzero/>
 *
...
char rev_nr_file[MAX_PATH] = "system/revision_nr.h";
char rev_sql_file[MAX_PATH] = "system/revision_sql.h";
